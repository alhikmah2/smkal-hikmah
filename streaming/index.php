          ...
          <div class="carousel-inner">
              ...
              <div class="row">
                <div class="col-lg my-2-4">
                  <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/C-iH2aQ-ewY?si=t1CMcpH5qz5yHJA6?rel=0" allowfullscreen></iframe>
                  </div>
                </div>
                <div class="col-lg my-2-4">
                  <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/dkbwPpPJCLo?si=3_XejjPzZ-Sq0Hfi?rel=0" allowfullscreen></iframe>
                  </div>
                </div>
                <div class="col-lg my-2-4">
                  <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/DbOa2bGLNWA?si=VTos8YAovlupeBSh?rel=0" allowfullscreen></iframe>
                  </div>
                </div>
              </div>
            </div>
            <div class="carousel-item">
              <div class="row">
                ...
                <div class="col-lg my-2-4">
                  <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/Q3bWmyvyA-I?si=Uf-k_GE80M286lls?rel=0" allowfullscreen></iframe>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="container">
      <div class="row justify-content-center">
        ...
        <div class="col-lg p-2 my-2">
          ...
          <ul class="list-group list-group-flush">
            <li class="list-group-item"><a href="admin/login.php">User Login</a></li>
      ...
      <div class="row my-2">
        <div class="col-lg my-2 text-center">
          <p>&copy; Copyright 2024 by Al Hikmah</p>
        </div>
      </div>
    </div>
  </div>
