    ...
    <div class="row mb-3 justify-content-center">
      <div class="col-lg">
        ...
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/9ix7TUGVYIo?si=aPyg29HyeJedfKqi" allowfullscreen></iframe>
        </div>
      </div>
    </div>
    <div class="row my-2">
      <div class="col-lg">
        ...
        <h4>Synopsis</h4>
        <p>Kisahnya bermula ketika seorang peretas bernama Thomas Anderson (Keanu Reeves) yang memiliki nama samaran Neo tiba-tiba menerima pesan aneh di monitor komputernya, pesan tersebut bertuliskan “The Matrix”.</p>
        <p>Film ini berada di bawah naungan rumah produksi dari Warner Bros Entertainment, Village Roadshow Pictures, Groucho II Film Partership, dan Silver Pictures..</p>
        <p>Sinema yang bergenre fiksi ilmiah ini dibintangi oleh Keanu Reeves, Laurence Fishburne, Carrie-Anne Moss, Hugo Weaving, Joe Pantoliano, Marcus Chong, Anthony Ray Parker, Julian Arahanga, Robert Taylor, Ada Nicodemou, Paul Goddard, Matt Doran, Gloria Foster, dan Belinda McClory.</p>
        <p>Lana Wachowski dan Lily Wachowski dalam film ini berperan sebagai sutradara sekaligus penulis naskah skenarionya.</p>
        <p>Film ini mengisahkan tentang dunia distopia dalam program komputer atau saat ini biasa disebut dengan teknologi metaverse, pemikiran manusia hidup di dalamnya dengan berbagai ilusi semu.</p>
        <p></p>
      </div>
    </div>
    <div class="row my-2">
